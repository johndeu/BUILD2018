        ...
        private static async Task RunAsync(ConfigWrapper config)
        {
            ...
            try
            {
                ...
                var input = new JobInputHttp(
                                    files: new List<String> {"https://nimbuspmteam.blob.core.windows.net/asset-b0d4d504-fb6d-45cf-a32d-ca5ec82e6b59/Seattle-short.mp4?sv=2015-07-08&sr=c&si=586fa479-7a71-4be8-9432-947752bf23ce&sig=Vgi4laMpUrgZHesUF0jjL%2B5JAlWylOJ2dDgx%2F3bFJfk%3D&se=2118-07-07T18%3A19%3A53Z"},
                                    label:"input1"
                                    );
