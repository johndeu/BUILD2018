...
const aadEndpoint = "https://login.windows-ppe.net/";
const armEndpoint = "https://api-dogfood.resources.windows-int.net/";

// args

const outputFolder = "c:\\temp\\visampleout";
const namePrefix = "build2018";
// const inputUrl = null;
// const inputFile = "c:\\data\\docker\\input.mp4";
const inputFile = null;
const inputUrl = "https://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/2b533311-b215-4409-80af-529c3e853622/Ignite-short.mp4";
...
msRestAzure.loginWithServicePrincipalSecret(aadClientId, aadSecret, aadTenantId, {
  ...
  try {
    ...
    let audioAnalyzerTransform = await ensureTransformExists(resourceGroup, accountName, audioAnalyzerTransformName, audioAnalyzerPreset());
    ...
    let transformName = selectTransform();
...
function selectTransform() {
  if (audioExtensions.indexOf(inputExtension) > -1) {
