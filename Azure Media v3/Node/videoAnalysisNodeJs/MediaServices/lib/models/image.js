...
class Image extends models['Video'] {
   ...
   * timestamp (ISO 8601, e.g: PT05S), or a frame count (e.g: 10 for the 10th
   * frame), or a relative value (e.g: 1%). Also supports a special value
   ...
   * generated. The value can be in absolute timestamp (ISO 8601, e.g: PT05S
   * for one image every 5 seconds), or a frame count (e.g: 30 for every 30
   * frames), or a relative value (e.g: 1%).
   * @member {string} [range] Describes the position in the input video at
   * which to stop generating thumbnails. The value can be in absolute
   * timestamp (ISO 8601, e.g: PT5M30S to stop at 5 minutes and 30 seconds), or
   * a frame count (e.g: 300 to stop at the 300th frame), or a relative value
   * (e.g: 100%).
   */
  constructor() {
    super();
