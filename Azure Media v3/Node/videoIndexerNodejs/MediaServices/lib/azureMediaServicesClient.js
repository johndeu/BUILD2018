...
/** Class representing a AzureMediaServices. */
class AzureMediaServices extends ServiceClient {
  /**
   * Create a AzureMediaServices.
...
module.exports = AzureMediaServices;
module.exports['default'] = AzureMediaServices;
module.exports.AzureMediaServices = AzureMediaServices;
module.exports.AzureMediaServicesModels = models;
